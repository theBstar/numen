...
def build_persons() -> list[EntityCreate]:
    people = [
        (P_ALICE, "Alice Chen", "alice@numen.team", "alice-chen", "lin-alice-001"),
        (P_BOB, "Bob Martinez", "bob@numen.team", "bob-martinez", "lin-bob-002"),
        (P_CAROL, "Carol Wu", "carol@numen.team", "carol-wu", "lin-carol-003"),
        (P_DAVID, "David Kim", "david@numen.team", "david-kim", "lin-david-004"),
        (P_EVE, "Eve Patel", "eve@numen.team", "eve-patel", "lin-eve-005"),
        (P_FRANK, "Frank Liu", "frank@numen.team", "frank-liu", "lin-frank-006"),
        (P_GRACE, "Grace Zhang", "grace@numen.team", "grace-zhang", "lin-grace-007"),
        (P_HANNAH, "Hannah Lee", "hannah@numen.team", "hannah-lee", "lin-hannah-008"),
    ]
    return [
        _entity(
            pid,
